...
import { downloadsPaused } from "@/lib/download-ops";
...
export const metadata = {
  ...
  description: "Download the PoolIndex desktop client for Windows. macOS uses the same codebase. No payment required to download. Closed Beta research tool — not a guarantee of funds or rewards.",
};
  ...
  return (
    <div className="mx-auto flex max-w-3xl flex-col gap-8">
      <div>
        ...
        <h1 className="mt-2 font-heading text-4xl tracking-tight">PoolIndex Desktop</h1>
        <p className="mt-4 text-lg text-muted-foreground">
          PoolIndex is a research and safety-check tool for public claim sources. Register with email, confirm your
          email, then download the desktop client. It does not claim tokens or hold funds. It does not guarantee that you
          will find money or rewards.
        </p>
      </div>
      ...
      <section className="rounded-xl border border-border/80 bg-card p-5">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Version {installer.version}. Unsigned Closed Beta — Windows SmartScreen may warn. Download does not require
          payment. Register with email, confirm your email, then download. After install: sign in, then choose Trial or Paid Subscription.
        </p>
        <div className="mt-4">
          {paused ? (
            <p className="text-sm text-muted-foreground">Windows installer is temporarily unavailable.</p>
      ...
      <section className="rounded-xl border border-border/80 bg-card p-5">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Same desktop client and server as Windows. Unsigned Closed Beta. Download does not require payment.
        </p>
        <div className="mt-4">
          {paused ? (
            <p className="text-sm text-muted-foreground">macOS download is temporarily unavailable.</p>
      ...
      <section>
        ...
        <ul className="mt-3 list-disc space-y-1 pl-5 text-sm text-muted-foreground">
          ...
          <li>
            <Link className="text-primary underline" href="/eula">
              EULA
            </Link>
          </li>
          <li>
            <Link className="text-primary underline" href="/disclaimer">
              Disclaimer
            </Link>
          </li>
        </ul>
