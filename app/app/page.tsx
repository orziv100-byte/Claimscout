    ...
    <div className="flex flex-col gap-12">
      <section className="flex flex-col gap-6 pt-4">
        ...
        <p className="text-xs text-muted-foreground">
          Desktop application. Register, verify email, and sign in. Free: one wallet, catalog, honest statuses, URL
          inspect.{" "}
          ...
          : five wallets, claim-window email alerts, Wayback/archive scan. Catalog below is secondary.
        </p>
      </section>
