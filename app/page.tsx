  ...
  return (
    <div className="mx-auto flex max-w-3xl flex-col gap-8">
      ...
      <p className="text-sm text-muted-foreground">
        After you confirm your email and sign in, you get a download portal — Windows installer, account, and
        Trial/Subscription. Scanning tools are in the desktop application.
      </p>
    </div>
  );
}
