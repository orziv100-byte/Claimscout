...
export type PaymentProvider = "none" | "paypal" | "mor" | "stripe";
...
const allowedProviders = new Set(["none", "paypal", "mor", "stripe"]);
...
/** Live commercial charges. Sandbox PayPal is not live. */
