...
export const TERMS_SECTIONS: { heading: string; body: string }[] = [
  ...
  },
  {
    ...
    body: "Poolindex does not guarantee discovery of any asset, reward, airdrop, or claim. It does not guarantee eligibility, payment, profit, monetary value, accuracy, or continued availability of third-party information. A result shown in Poolindex is not a guarantee that you are eligible or that you will receive anything.",
  },
  {
    heading: "Third-party information",
    body: "External information may be incomplete, outdated, inaccurate, unavailable, or changed by the original provider. You must independently verify results before taking action. Third-party links and results are not automatically endorsements by Poolindex.",
  },
  {
    heading: "No investment advice and no fund management",
    body: "Poolindex does not provide investment advice. Poolindex does not manage user funds. You remain responsible for your own decisions and for any transaction you approve in your own wallet.",
  },
  {
    heading: "Public addresses only",
    body: "Poolindex does not require seed phrases or private keys. Wallet analysis uses public wallet addresses and other read-only data only. Never enter a seed phrase, recovery phrase, or private key into Poolindex.",
  },
  {
    heading: "Acceptable use",
    body: "Use Poolindex only on wallets and research you are authorized to review. Do not use the product to attack systems, steal credentials, or collect other people's secrets. We may suspend accounts that abuse the Beta, overload the service, or violate these terms.",
  },
  {
    heading: "Plans",
    body: "The Free plan is limited to a smaller source set and one wallet. Poolindex Pro is a planned paid plan (target $40) with more sources and up to five wallets. Payment processing is not active in this Closed Beta. Plan limits are enforced on the server.",
  },
  {
    heading: "Changes",
...
export const PRIVACY_SECTIONS: { heading: string; body: string }[] = [
  ...
  },
  {
    ...
    body: "If you paste or connect a wallet, Poolindex stores the public address with your account so plan wallet limits can be enforced. Addresses are not private keys. You can clear a session in the product; operators may retain bound addresses while your Beta account exists so limits cannot be bypassed.",
  },
  {
  ...
  {
    heading: "What Poolindex does not collect",
    body: "Poolindex does not request or intentionally collect seed phrases, private keys, or wallet recovery phrases. Do not paste them. If input looks like secret material, it is rejected and is not stored as a wallet or password.",
  },
  {
    heading: "Retention",
