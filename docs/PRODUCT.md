...
Claim Scout is a research and source-scanning tool. It helps people search, organize, and review public information about airdrops, faucets, giveaways, archived offers, and similar claims. It is not a wallet, exchange, broker, recovery service, or payment processor.

## Purpose

Help a user answer: “Was something publicly offered, is the source still there, and does this public address appear eligible — without handing Claim Scout a seed phrase?”
...
2. Optionally run a live scan of plan-allowed sources (GitHub, Wayback, archive.org, Reddit, Bitcointalk — gated by Free/Scout+).
...
- Claim Scout never requests, stores, or transmits seed phrases or private keys.
...
- Scout+ (planned $40, no billing yet): catalog + GitHub + Wayback + archive.org (~70% of sources), 5 wallets.
...
4. Scout+ server-side caps + catalog watch.
